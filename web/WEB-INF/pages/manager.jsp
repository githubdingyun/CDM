				...
				<li class="nav-header">
					<div class="dropdown profile-element  my-profile-content ">
						...
						<ul class="dropdown-menu animated fadeInRight m-t-xs">
							...
							<li><a href="complain.jsp">我要投诉</a></li>
							<li class="divider"></li>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>
						<strong>你确定删除这个学生吗</strong> 没有后悔药的.
					</p>
				</div>
	...
	<div class="modal inmodal" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content animated bounceInRight">
				...
				<div class="modal-body">
					<p>
						<strong>这是这个学生的个人简介</strong>
					</p>
					<div class="form-group">
						<label>输入评价</label> <input type="email"
							placeholder="请诚恳的输入你的评价，不要欺骗他" class="form-control">
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
				...
				<form class="m-t" role="form" action="UpdateSvt?id=${worker.wid}">
					...
					<div class="form-group">
						<div class="checkbox i-checks">
							<label> <input type="checkbox"><i></i>我已保存我的账户信息
							</label>
						</div>
