                        ...
                        <div class="ibox-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <c:forEach items="${materials}" var="i">
                                        <tr class="gradeX" id="row">
                                            <td>${i.materialId}</td>
                                            <td>﻿﻿ ${i.materialName}</td>
                                            <td>﻿﻿ ${i.materialPrice}</td>
                                            <td>${i.materialSize}</td>
                                            <td class="center">
                                                <a href="${pageContext.request.contextPath}/MaterialController/query.do?materialId=${i.materialId}">
                                                ...
                                                <c:if test="${worker.subjectId == 0 || worker.subjectId == 1}">
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                            onclick="deleteUser(${i.materialId})">
                                                        删除
                                                    </button>
                                                </c:if>
                                            </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <form class="m-t" role="form" action="${pageContext.request.contextPath}/MaterialController/update.do"
                      method="post">
                    <div class="form-group">
                        材料id:<input class="form-control" type="text" name="materialId" value="" placeholder="材料id">
                    </div>
                    <div class="form-group">
                        材料名称:<input class="form-control" type="text" name="materialName" value=""
                                   placeholder="材料名称">
                    </div>
                    <div class="form-group">
                        材料花费: <input class="form-control" type="text" name="materialPrice" value="" placeholder="材料花费">

                    </div>
                    <div class="form-group">
                        材料尺寸: <input class="form-control" type="text" name="materialSize" value=""
                                   placeholder="材料尺寸">
                    </div>
    ...
    function deleteUser(id) {
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    /*这里为请求地址*/
                    url: "${pageContext.request.contextPath}/MaterialController/delete.do?materialId=" + id,
                    dataType: "html",
